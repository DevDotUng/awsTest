...
public class NoticeServiceImp implements NoticeService {
	...
	@Override
	public List<Notice> getViewList(boolean pub) {
		// TODO Auto-generated method stub
		return getViewList(1, "title", "", pub);
	}
	
	@Override
	public List<Notice> getViewList(String field, String query, boolean pub) {
		// TODO Auto-generated method stub
		return getViewList(1, field, query, pub);
	}
	
	@Override
	public List<Notice> getViewList(int page, String field, String query, boolean pub) {
		
		int size = 10;
		int offset = 0 + (page-1) * 10;
		
		List<Notice> list = noticeDao.getViewList(offset, size, field, query, pub);
